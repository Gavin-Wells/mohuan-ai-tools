...
export const providerPresets: ProviderPreset[] = [
  {
    ...
    settingsConfig: {
      env: {
        ANTHROPIC_BASE_URL: MOHUAN_ANTHROPIC_BASE_URL,
        ANTHROPIC_AUTH_TOKEN: "",
        ANTHROPIC_MODEL: MOHUAN_DEFAULT_CLAUDE_MODEL,
        ANTHROPIC_DEFAULT_HAIKU_MODEL: MOHUAN_DEFAULT_CLAUDE_HAIKU_MODEL,
        ANTHROPIC_DEFAULT_SONNET_MODEL: MOHUAN_DEFAULT_CLAUDE_SONNET_MODEL,
        ANTHROPIC_DEFAULT_OPUS_MODEL: MOHUAN_DEFAULT_CLAUDE_OPUS_MODEL,
      },
    },
